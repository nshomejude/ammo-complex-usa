    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[400px] flex items-center justify-center bg-gradient-to-br from-[#2E2E2E] to-[#556B2F]">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <Badge className="mb-4 bg-[#CBB994] text-black">CONTACT US</Badge>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 uppercase font-['Oswald']">Reach Us</h1>
          <p className="text-xl text-gray-200">We're here to help with your inquiries</p>
        </div>
      </section>
