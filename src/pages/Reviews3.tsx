...
import { Star, SlidersHorizontal, Plus } from "lucide-react";
          ...
          <div className="flex-1">
            ...
            <div className="columns-1 md:columns-2 xl:columns-3 gap-6 space-y-6">
              {paginatedReviews.map(review => (
                <Card 
                  key={review.id} 
                  className="break-inside-avoid bg-card border border-border hover:shadow-xl transition-shadow duration-300 cursor-pointer hover:border-primary/50"
                  onClick={() => {
